    ...
    QuerySet= Class.create({
        ...
        ,create: function(args, callback){
            var
                querySet= this
                ,postCreate= function(){
                    broke.DOM.events.trigger(window, 'broke.' + querySet.model.__name__.toLowerCase() + '.post_create', [this]);
...
//                }
    ...
    Model= Class.create({
        ...
        ,update: function(fields, updateDOM){
            ...
            broke.DOM.events.trigger(window, 'broke.' + className + '.post_update', [this]);
        ...
        ,save: function(saveSettings, callback){
            ...
            console.log('saveSettings.commit', saveSettings.commit);
