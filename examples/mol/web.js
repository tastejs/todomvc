...
(function ($) {
    ...
    $.$mol_icon_alert_circle = $mol_icon_alert_circle;
})($ || ($ = {}));
...
(function ($) {
    class $my_button_danger extends $.$mol_view {
        sub() {
    ...
    __decorate([
        $.$mol_mem
    ], $my_button_danger.prototype, "Icon", null);
    $.$my_button_danger = $my_button_danger;
})($ || ($ = {}));
