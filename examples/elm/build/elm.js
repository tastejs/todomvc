								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_evancz$elm_todomvc$Todo_Task$Completed(!model.completed)),
										_1: {ctor: '[]'}
									}
								}
							}
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_evancz$elm_todomvc$Todo_Task$Delete),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(description),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$name('title'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id(elementId),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_evancz$elm_todomvc$Todo_Task$Edit),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onBlur(_evancz$elm_todomvc$Todo_Task$Commit),
											_1: {
												ctor: '::',
												_0: A2(_evancz$elm_todomvc$Todo_Task$onFinish, _evancz$elm_todomvc$Todo_Task$Commit, _evancz$elm_todomvc$Todo_Task$Cancel),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _evancz$elm_todomvc$Todo$UrlChange = function (a) {
...
var _evancz$elm_todomvc$Todo$update = F2(
	function (msg, model) {
		var _p2 = A2(_elm_lang$core$Debug$log, 'MESSAGE: ', msg);
		switch (_p2.ctor) {
			case 'NoOp':
				...
				var newModel = _elm_lang$core$String$isEmpty(description) ? model : _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						tasks: A2(
							...
							{
								ctor: '::',
								_0: A2(_evancz$elm_todomvc$Todo_Task$init, description, model.uid),
								_1: {ctor: '[]'}
							})
					});
				return {
			...
			case 'UpdateTask':
				...
				var updateTask = function (t) {
					return _elm_lang$core$Native_Utils.eq(t.id, _p2._0._0) ? A2(_evancz$elm_todomvc$Todo_Task$update, _p4, t) : _elm_lang$core$Maybe$Just(t);
				};
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
				...
				if (_p3.ctor === 'Focus') {
					return A2(
						...
						{
							ctor: '::',
							_0: _evancz$elm_todomvc$Todo$save(newModel),
							_1: {
								ctor: '::',
								_0: _evancz$elm_todomvc$Todo$focusTask(_p3._0),
								_1: {ctor: '[]'}
							}
						});
				} else {
			...
			default:
				return A2(_evancz$elm_todomvc$Todo$urlUpdate, _p2._0, model);
		}
	});
var _evancz$elm_todomvc$Todo$urlUpdate = F2(
	function (loc, model) {
		var _p6 = _evancz$elm_todomvc$Todo$fromUrl(loc.hash);
		if (_p6.ctor === 'Just') {
			return A2(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: A2(_evancz$elm_todomvc$Todo_Task$onFinish, _evancz$elm_todomvc$Todo$Add, _evancz$elm_todomvc$Todo$NoOp),
												_1: {ctor: '[]'}
											}
										}
									}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Lazy$lazy, _evancz$elm_todomvc$Todo$taskEntry, model.field),
					_1: {
						ctor: '::',
						_0: A3(_elm_lang$html$Html_Lazy$lazy2, _evancz$elm_todomvc$Todo$taskList, model.visibility, model.tasks),
						_1: {
							ctor: '::',
							_0: A3(_elm_lang$html$Html_Lazy$lazy2, _evancz$elm_todomvc$Todo$controls, model.visibility, model.tasks),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _evancz$elm_todomvc$Todo$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_evancz$elm_todomvc$Todo$UrlChange,
	{view: _evancz$elm_todomvc$Todo$view, init: _evancz$elm_todomvc$Todo$init, update: _evancz$elm_todomvc$Todo$update, subscriptions: _evancz$elm_todomvc$Todo$subscriptions})(
