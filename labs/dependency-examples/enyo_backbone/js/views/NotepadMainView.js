...
enyo.kind({
    ...
    tag: 'section', // give it a specific html tag
            ...
            components: [{
                    ...
                    components: [{
                            ...
                            components: [{
                                    ...
                                    markComplete: function (inSender) {
                            ...
                            handlers: {
                                onkeypress: 'saveExisting'
                            },
                            saveExisting: function (inSender, inEvent) {
                                if (inEvent.keyCode === ENTER_KEY) {
                                    this.bubble('onSaveExistingKeypress');
