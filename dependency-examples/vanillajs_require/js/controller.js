/*global $$, define */
define('Controller', ['helpers', 'Router'], function (helpers, Router) {
	'use strict';
	window = helpers;
	...
	function Controller(model, view) {
		...
		this.$toggleAll = window.$$('#toggle-all');
		this.$todoList = window.$$('#todo-list');
		this.$todoItemCounter = window.$$('#todo-count');
		this.$clearCompleted = window.$$('#clear-completed');
	...
	Controller.prototype.removeItem = function (id) {
		this.model.remove(id, function () {
			this.$todoList.removeChild(window.$$('[data-id="' + id + '"]'));
		}.bind(this));
	...
	Controller.prototype._updateFilterState = function () {
		...
		window.$('#filters .selected').each(function (item) {
			item.className = '';
		});

		window.$$('#filters [href="#/' + currentPage + '"]').className = 'selected';
	};
