...
(function (global){
function _model(e){var t;if(e="object"==typeof e?e:{},null!=e.__MODEL_REFERENCE__)throw new Error('"__MODEL_REFERENCE__" is a reserved key');if(e.__MODEL_REFERENCE__=models.length,null!=e.event)throw new Error('"event" is a reserved key');return t=struct(e),t.event=_modelEvent,t.ev=_modelEvent,models.push(t),t}function _modelFor(e){var t;if(null==e.__MODEL_REFERENCE__)throw new Error("__MODEL_REFERENCE__ not found on state");if(t=models[e.__MODEL_REFERENCE__],null==t)throw new Error("__MODEL_REFERENCE__ is invalid");return t}function _event(e,t,r){var a;return a=nextEventHandlerKey++,nextEventHandlers[a]=function(a){t(e,{event:a.eventData,form:a.formData,custom:r})},a}function _modelEvent(e,t){return _event(this,e,t)}function _postLocalStorage(e){if("object"==typeof e&&null!=e.key&&localStorageQueue.push(e),localStorageQueue.length)if("function"==typeof duet.postMessageToUser)for(;localStorageQueue.length;)duet.postMessageToUser({type:"LOCAL_STORAGE",data:localStorageQueue.shift()});else null==duet.postMessageToUser&&"user"!==activeThread&&setTimeout(_postLocalStorage,10)}function _localStorage(e,t){var r;return"function"==typeof t?(r=nextLocalStorageHandlerKey++,localStorageHandlers[r]=function(e){t(e.value)},_postLocalStorage({handlerKey:r,key:e}),r):void _postLocalStorage({key:e,value:t})}function _postCSS(e){if("string"==typeof e&&e.length&&cssQueue.push(e),cssQueue.length)if("function"==typeof duet.postMessageToUser)for(;cssQueue.length;)duet.postMessageToUser({type:"CSS",data:cssQueue.shift()});else null==duet.postMessageToUser&&"user"!==activeThread&&setTimeout(_postCSS,10)}function _css(){var e,t;return e=slice.call(arguments),t=csjs.apply(null,e),"user"!==activeThread&&_postCSS(csjs.getCss(t)),t}function _domFor(e){return hyperx(hyperstyles(vdom.h,e))}function _msg(e){return function(t){return e(t.data.type,t.data.data)}}function _userThread(e,t,r){function a(t,r){function a(e,t){var a=r[t];return t.charAt(0)!==t.charAt(0).toLowerCase()||"number"!=typeof a&&"string"!=typeof a&&"boolean"!=typeof a||(e[t]=a),e}var o,n,s;o=r.target["data-"+t],"string"==typeof o&&(n=Object.keys(r.constructor.prototype).reduce(a,{}),s=getFormData(r.target),new RegExp("\\b"+t+"\\b").test(r.target["data-default"])||r.preventDefault(),e.postMessage({type:"EVENT",data:{handlerKey:o,eventType:t,eventData:n,formData:s}}))}function o(e){document.addEventListener(e,a.bind(null,e))}function n(e){insertCSS(e)}function s(e){window.requestAnimationFrame(function(){patch(target,e)})}function l(t){return t.value?void localStorage.setItem(t.key,t.value):e.postMessage({type:"LOCAL_STORAGE",data:{handlerKey:t.handlerKey,value:localStorage.getItem(t.key)}})}function u(e,t){switch(r.isDebug&&console.debug("APP::"+e,t),e){case"CSS":n(t);break;case"PATCH":s(t);break;case"LOCAL_STORAGE":l(t)}}var i;if(i=document.querySelector(t),null==i)throw new Error("selector did not match an element");target=document.createElement("div"),i.insertBefore(target,i.firstChild),eventNames.forEach(o),window.onclick=function(t){"a"===t.target.localName&&void 0!==t.target.href&&window.location.host===t.target.host&&(t.preventDefault(),e.postMessage({type:"LOCATION",data:t.target.href}),window.history.pushState({},null,t.target.href))},window.onpopstate=function(){e.postMessage({type:"LOCATION",data:document.location.href})},duet.postMessageToApp=e.postMessage.bind(e),e.onmessage=_msg(u),e.postMessage({type:"READY",data:document.location.href})}function _appThread(e,t,r){function a(t){var r,a,o;r=d(t),a=vdom.diff(c,r),o=serialize(a),c=r,currentEventHandlers=nextEventHandlers,nextEventHandlers={},nextEventHandlerKey=0,e.postMessage({type:"PATCH",data:o})}function o(e,t,r){if(d)throw new Error("tried to initialise app more than once");d=e,c=vdom.h("div"),a(t()),t(a),h=r,s(f)}function n(e){f=e,t(o)}function s(e){var t,a;"function"==typeof h&&(r.isHashRouter?(a=e.split("#"),a.length>1&&(a.shift(),t=hashMatch("#".concat(a.join("#"))))):(t=pathnameMatch(e),t.length||(t="/")),t&&h(t))}function l(e){null!=currentEventHandlers[e.handlerKey]&&currentEventHandlers[e.handlerKey](e)}function u(e){null!=localStorageHandlers[e.handlerKey]&&localStorageHandlers[e.handlerKey](e)}function i(e,t){switch(r.isDebug&&console.debug("USER::"+e,t),e){case"READY":n(t);break;case"LOCATION":s(t);break;case"EVENT":l(t);break;case"LOCAL_STORAGE":u(t)}}var c,d,h,f;duet.postMessageToUser=e.postMessage.bind(e),e.onmessage=_msg(i)}function _duet(e,t,r){var a;if(r="object"==typeof r&&null!==r&&r||{},!r.forceSingleThread){if(WORKER_ENABLED)return activeThread="user",_userThread(new global.Worker(PATHNAME),t,r);if(IN_WORKER_CONTEXT)return activeThread="app",_appThread(global.self,e,r)}isSingleThreaded=!0,a=new SingleThread,setTimeout(function(){_appThread(a.self,e,r),setTimeout(function(){_userThread(a.worker,t,r)},0)},0)}var console=require("console"),extend=require("xtend/mutable"),struct=require("observ-struct"),varhash=require("observ-varhash"),value=require("observ"),csjs=require("csjs"),insertCSS=require("insert-css"),vdom=require("virtual-dom"),getFormData=require("form-data-set/element"),hyperstyles=require("hyperstyles"),hyperx=require("hyperx"),serialize=require("vdom-serialized-patch/serialize"),patch=require("vdom-serialized-patch/patch"),router=require("wayfarer"),pathnameMatch=require("pathname-match"),hashMatch=require("hash-match"),eventNames=require("./eventNames"),SingleThread=require("./SingleThread"),slice=Array.prototype.slice,WORKER_ENABLED=!(global!==global.window||!global.URL||!global.Worker),IN_WORKER_CONTEXT=!(global!==global.self||!global.location),PATHNAME=WORKER_ENABLED&&function(){var e,t;return e=global.document.getElementsByTagName("script"),t=e[e.length-1].src,new global.URL(t).pathname}(),activeThread,isSingleThreaded=!WORKER_ENABLED&&!IN_WORKER_CONTEXT,models=[],nextEventHandlerKey=0,currentEventHandlers={},nextEventHandlers={},nextLocalStorageHandlerKey=0,localStorageHandlers={},localStorageQueue=[],cssQueue=[],duet=extend(_duet,{struct:struct,varhash:varhash,value:value,model:_model,modelFor:_modelFor,event:_event,ev:_event,localStorage:_localStorage,css:_css,dom:hyperx(vdom.h),domFor:_domFor,router:router});module.exports=duet;


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./SingleThread":1,"./eventNames":2,"console":6,"csjs":14,"form-data-set/element":24,"hash-match":27,"hyperstyles":28,"hyperx":30,"insert-css":31,"observ":36,"observ-struct":32,"observ-varhash":34,"pathname-match":37,"vdom-serialized-patch/patch":54,"vdom-serialized-patch/serialize":55,"virtual-dom":59,"wayfarer":90,"xtend/mutable":94}],4:[function(require,module,exports){
...
},{"assert":4,"date-now":7,"util":11}],7:[function(require,module,exports){
...
},{"./lib/csjs":17}],13:[function(require,module,exports){
"use strict";module.exports=require("./lib/get-css");


},{"./lib/get-css":20}],14:[function(require,module,exports){
...
"use strict";function selectorize(e){return isComposition(e)?e.selector:e}function joiner(e,o){return e.map(function(e,s){return s!==o.length?e+o[s]:e}).join("")}var extractExtends=require("./css-extract-extends"),isComposition=require("./composition").isComposition,makeComposition=require("./composition").makeComposition,scopify=require("./scopeify"),cssKey=require("./css-symbol");module.exports=function(e){var o=Array.prototype.slice.call(arguments,1),s=joiner(e,o.map(selectorize)),i=o.reduce(function(e,o){return isComposition(o)&&o.classNames.forEach(function(s,i){e[s]=o.unscoped[i]}),e},{}),t=scopify(s,i),r=Object.assign({},t.classes,t.keyframes),n=extractExtends(t.css,r),c=n.extensions,u=Object.keys(r).reduce(function(e,o){var s=i[r[o]]?i[r[o]]:r[o];return e[s]=c[o]?c[o]:makeComposition([o],[s],Boolean(r[o])),e},{});return u[cssKey]=n.css,u};


},{"./composition":16,"./css-extract-extends":18,"./css-symbol":19,"./scopeify":23}],18:[function(require,module,exports){
"use strict";function splitter(e){return e.split(",").map(getClassName)}function getClassName(e){var s=e.trim();return"."===s[0]?s.substr(1):s}var makeComposition=require("./composition").makeComposition,regex=/(.*?)(\s+?)(extends\s+?)((?:.|\n)*?){(?:(?:.|\n)*?)}/g;module.exports=function(e,s){function t(e,t){var n=getClassName(t[1]),r=t[3],i=t[4],o=t.index+t[1].length+t[2].length,a=r.length+i.length;e.css=e.css.slice(0,o)+e.css.slice(o+a);var c=[n].concat(splitter(i)),u=c.map(function(e){return s[e]?s[e]:e});return e.extensions[n]=makeComposition(c,u),e}for(var n,r=[];n=regex.exec(e);)r.unshift(n);return r.reduce(t,{css:e,extensions:{}})};
...
},{"./css-symbol":19}],21:[function(require,module,exports){
...
},{"./base62-encode":15,"./hash-string":21}],23:[function(require,module,exports){
...
},{"./index.js":25,"dom-walk":26}],25:[function(require,module,exports){
...
},{"./transform":29}],29:[function(require,module,exports){
...
function quot(T){return T===ATTR_VALUE_SQ||T===ATTR_VALUE_DQ}function has(T,A){return hasOwn.call(T,A)}function selfClosing(T){return closeRE.test(T)}var VAR=0,TEXT=1,OPEN=2,CLOSE=3,ATTR=4,ATTR_KEY=5,ATTR_KEY_W=6,ATTR_VALUE_W=7,ATTR_VALUE=8,ATTR_VALUE_SQ=9,ATTR_VALUE_DQ=10;module.exports=function(T,A){function e(T){return"function"==typeof T?T:"string"==typeof T?T:T&&"object"==typeof T?T:t("",T)}A||(A={});var t=A.concat||function(T,A){return String(T)+String(A)};return function(A){function E(T){var A=[];_===ATTR_VALUE_W&&(_=ATTR);for(var e=0;e<T.length;e++){var t=T.charAt(e);_===TEXT&&"<"===t?(R.length&&A.push([TEXT,R]),R="",_=OPEN):">"!==t||quot(_)?_===TEXT?R+=t:_===OPEN&&/\s/.test(t)?(A.push([OPEN,R]),R="",_=ATTR):_===OPEN?R+=t:_===ATTR&&/[\w-]/.test(t)?(_=ATTR_KEY,R=t):_===ATTR_KEY&&/\s/.test(t)?(A.push([ATTR_KEY,R]),R="",_=ATTR_KEY_W):_===ATTR_KEY&&"="===t?(A.push([ATTR_KEY,R]),R="",_=ATTR_VALUE_W):_===ATTR_KEY?R+=t:_===ATTR_KEY_W&&"="===t?_=ATTR_VALUE_W:_!==ATTR_KEY_W||/\s/.test(t)?_===ATTR_VALUE_W&&'"'===t?_=ATTR_VALUE_DQ:_===ATTR_VALUE_W&&"'"===t?_=ATTR_VALUE_SQ:_===ATTR_VALUE_DQ&&'"'===t?(A.push([ATTR_VALUE,R]),R="",_=ATTR):_===ATTR_VALUE_SQ&&"'"===t?(A.push([ATTR_VALUE,R]),R="",_=ATTR):_!==ATTR_VALUE_W||/\s/.test(t)?_===ATTR_VALUE&&/\s/.test(t)?(A.push([ATTR_VALUE,R]),R="",_=ATTR):(_===ATTR_VALUE||_===ATTR_VALUE_SQ||_===ATTR_VALUE_DQ)&&(R+=t):(_=ATTR_VALUE,e--):(_=ATTR,e--):(_===OPEN?A.push([OPEN,R]):_===ATTR_KEY?A.push([ATTR_KEY,R]):_===ATTR_VALUE&&R.length&&A.push([ATTR_VALUE,R]),A.push([CLOSE]),R="",_=TEXT)}return _===TEXT&&R.length?(A.push([TEXT,R]),R=""):_===ATTR_VALUE&&R.length?(A.push([ATTR_VALUE,R]),R=""):_===ATTR_VALUE_DQ&&R.length?(A.push([ATTR_VALUE,R]),R=""):_===ATTR_VALUE_SQ&&R.length?(A.push([ATTR_VALUE,R]),R=""):_===ATTR_KEY&&(A.push([ATTR_KEY,R]),R=""),A}for(var _=TEXT,R="",n=arguments.length,s=[],r=0;r<A.length;r++)if(n-1>r){var h=arguments[r+1],l=E(A[r]),u=_;u===ATTR_VALUE_DQ&&(u=ATTR_VALUE),u===ATTR_VALUE_SQ&&(u=ATTR_VALUE),u===ATTR_VALUE_W&&(u=ATTR_VALUE),u===ATTR&&(u=ATTR_KEY),l.push([VAR,u,h]),s.push.apply(s,l)}else s.push.apply(s,E(A[r]));for(var p=[null,{},[]],V=[[p,-1]],r=0;r<s.length;r++){var o=V[V.length-1][0],l=s[r],a=l[0];if(a===OPEN&&/^\//.test(l[1])){var L=V[V.length-1][1];V.length>1&&(V.pop(),V[V.length-1][0][2][L]=T(o[0],o[1],o[2]))}else if(a===OPEN){var i=[l[1],{},[]];o[2].push(i),V.push([i,o[2].length-1])}else if(a===ATTR_KEY||a===VAR&&l[1]===ATTR_KEY){for(var U="";r<s.length;r++)if(s[r][0]===ATTR_KEY)U=t(U,s[r][1]);else{if(s[r][0]!==VAR||s[r][1]!==ATTR_KEY)break;U=t(U,s[r][2])}for(;r<s.length;r++)if(s[r][0]===ATTR_VALUE)o[1][U]?o[1][U]=t(o[1][U],s[r][1]):o[1][U]=e(s[r][1]);else{if(s[r][0]!==VAR||s[r][1]!==ATTR_VALUE){r--;break}o[1][U]?o[1][U]=t(o[1][U],s[r][2]):o[1][U]=e(s[r][2])}}else if(a===ATTR_KEY)o[1][l[1]]=!0;else if(a===VAR&&l[1]===ATTR_KEY)o[1][l[2]]=!0;else if(a===CLOSE){if(selfClosing(o[0])&&V.length){var L=V[V.length-1][1];V.pop(),V[V.length-1][0][2][L]=T(o[0],o[1],o[2])}}else if(a===VAR&&l[1]===TEXT)void 0===l[2]||null===l[2]?l[2]="":l[2]||(l[2]=t("",l[2])),Array.isArray(l[2][0])?o[2].push.apply(o[2],l[2]):o[2].push(l[2]);else{if(a!==TEXT)throw new Error("unhandled: "+a);o[2].push(l[1])}}if(p[2].length>1&&/^\s*$/.test(p[2][0])&&p[2].shift(),p[2].length>2||2===p[2].length&&/\S/.test(p[2][1]))throw new Error("multiple root elements must be wrapped in an enclosing tag");return p[2][0]}};var hasOwn=Object.prototype.hasOwnProperty,closeRE=RegExp("^("+["area","base","basefont","bgsound","br","col","command","embed","frame","hr","img","input","isindex","keygen","link","meta","param","source","track","wbr"].join("|")+")(?:[.#][a-zA-Z0-9-￿_:-]+)*$");
...
},{"observ":36,"xtend":33}],33:[function(require,module,exports){
...
function ObservVarhash(e,r){function n(e,n){if(checkKey(e),void 0===n)throw new Error("cannot varhash.put(key, undefined).");var t=isFn(n)?n:r(n,e),i=extend(this());return i[e]=isFn(t)?t():t,isFn(this._removeListeners[e])&&this._removeListeners[e](),this._removeListeners[e]=isFn(t)?t(s(this,e)):null,setNonEnumerable(i,"_diff",diff(e,i[e])),this[e]=t,o=i,u(i),o=NO_TRANSACTION,this}function t(e){var r=extend(this());return isFn(this._removeListeners[e])&&this._removeListeners[e](),delete this._removeListeners[e],delete r[e],delete this[e],setNonEnumerable(r,"_diff",diff(e,void 0)),u(r),this}function s(e,r){return function(n){if(a!==n){var t=extend(e());t[r]=n,setNonEnumerable(t,"_diff",diff(r,n)),o=t,e.set(t),o=NO_TRANSACTION}}}r=r||function(e){return e};var i={},o=NO_TRANSACTION,a=NO_TRANSACTION,f=Observ(i);setNonEnumerable(f,"_removeListeners",{}),setNonEnumerable(f,"get",get.bind(f)),setNonEnumerable(f,"put",n.bind(f)),setNonEnumerable(f,"delete",t.bind(f));for(var v in e)f[v]=isFn(e[v])?e[v]:r(e[v],v),isFn(f[v])&&(f._removeListeners[v]=f[v](s(f,v)));var u=f.set;f.set=function(e){if(o===e)return u(e);var r=extend(e);setNonEnumerable(r,"_diff",e),u(r)};var h={};for(v in e){var d=f[v];checkKey(v),h[v]=isFn(d)?d():d}return f.set(h),f(function(r){if(o!==r)for(var n in e){var t=e[n],s=r[n];isFn(t)&&t()!==r[n]&&(a=s,t.set(r[n]),a=NO_TRANSACTION)}}),f}function get(e){return this[e]}function diff(e,r){var n={};return n[e]=r&&r._diff?r._diff:r,n}function isFn(e){return"function"==typeof e}function setNonEnumerable(e,r,n){Object.defineProperty(e,r,{value:n,writable:!0,configurable:!0,enumerable:!1})}function checkKey(e){if(blacklist[e])throw new Error("cannot create an observ-varhash with key `"+e+"`. "+blacklist[e])}var Observ=require("observ"),extend=require("xtend"),NO_TRANSACTION={};module.exports=ObservVarhash;var blacklist={name:"Clashes with `Function.prototype.name`.",get:"get is a reserved key of observ-varhash method",put:"put is a reserved key of observ-varhash method","delete":"delete is a reserved key of observ-varhash method",_diff:"_diff is a reserved key of observ-varhash method",_removeListeners:"_removeListeners is a reserved key of observ-varhash"};


},{"observ":36,"xtend":35}],35:[function(require,module,exports){
function extend(){for(var r={},e=0;e<arguments.length;e++){var n=arguments[e];for(var t in n)n.hasOwnProperty(t)&&(r[t]=n[t])}return r}module.exports=extend;
...
},{"assert":4}],38:[function(require,module,exports){
function applyProperties(t,e,r){for(var o in e){var i=e[o];void 0===i?removeProperty(t,o,r):isSoftSetHook(i)?(removeProperty(t,o,i,r),t[o]=i.value):isObject(i)?patchObject(t,e,r,o,i):t[o]=i}}function removeProperty(t,e,r){if(r){var o=r[e];if("attributes"===e)for(var i in o)t.removeAttribute(i);else if("style"===e)for(var v in o)t.style[v]="";else"string"==typeof o?t[e]="":t[e]=null}}function patchObject(t,e,r,o,i){var v=r?r[o]:void 0;if("attributes"!==o){if(v&&isObject(v)&&getPrototype(v)!==getPrototype(i))return void(t[o]=i);isObject(t[o])||(t[o]={});var s="style"===o?"":void 0;for(var p in i){var f=i[p];t[o][p]=void 0===f?s:f}}else for(var a in i){var c=i[a];void 0===c?t.removeAttribute(a):t.setAttribute(a,c)}}function getPrototype(t){return Object.getPrototypeOf?Object.getPrototypeOf(t):t.__proto__?t.__proto__:t.constructor?t.constructor.prototype:void 0}var isObject=require("./isObject"),isSoftSetHook=require("./isSoftSetHook");module.exports=applyProperties;


},{"./isObject":42,"./isSoftSetHook":43}],39:[function(require,module,exports){
...
},{"./applyProperties":38,"./isVNode":44,"./isVText":45}],40:[function(require,module,exports){
...
},{"./patchRecursive":47}],42:[function(require,module,exports){
...
},{"../patchTypes":49,"./applyProperties":38,"./createElement":39}],47:[function(require,module,exports){
...
},{"./domIndex":40,"./patchOp":46}],48:[function(require,module,exports){
...
},{"../patchTypes":49,"vdom-as-json/toJson":53}],51:[function(require,module,exports){
...
},{"./types":52,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":75}],52:[function(require,module,exports){
module.exports={VirtualTree:1,VirtualPatch:2,VirtualNode:3,SoftSetHook:4};
...
},{"./lib/toJson":51}],54:[function(require,module,exports){
module.exports=require("./lib/patch");


},{"./lib/patch":41}],55:[function(require,module,exports){
module.exports=require("./lib/serialize");


},{"./lib/serialize":50}],56:[function(require,module,exports){
var createElement=require("./vdom/create-element.js");module.exports=createElement;


},{"./vdom/create-element.js":69}],57:[function(require,module,exports){
var diff=require("./vtree/diff.js");module.exports=diff;


},{"./vtree/diff.js":89}],58:[function(require,module,exports){
var h=require("./virtual-hyperscript/index.js");module.exports=h;


},{"./virtual-hyperscript/index.js":76}],59:[function(require,module,exports){
...
},{"./create-element.js":56,"./diff.js":57,"./h.js":58,"./patch.js":67,"./vnode/vnode.js":85,"./vnode/vtext.js":87}],60:[function(require,module,exports){
...
},{"../vnode/is-vhook.js":80,"is-object":65}],69:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":78,"../vnode/is-vnode.js":81,"../vnode/is-vtext.js":82,"../vnode/is-widget.js":83,"./apply-properties":68,"global/document":64}],70:[function(require,module,exports){
...
},{"ev-store":61}],75:[function(require,module,exports){
...
},{"../vnode/is-thunk":79,"../vnode/is-vhook":80,"../vnode/is-vnode":81,"../vnode/is-vtext":82,"../vnode/is-widget":83,"../vnode/vnode.js":85,"../vnode/vtext.js":87,"./hooks/ev-hook.js":74,"./hooks/soft-set-hook.js":75,"./parse-tag.js":77,"x-is-array":66}],77:[function(require,module,exports){
...
},{"browser-split":60}],78:[function(require,module,exports){
...
},{"../vnode/is-vhook":80,"is-object":65}],89:[function(require,module,exports){
...
},{"../vnode/handle-thunk":78,"../vnode/is-thunk":79,"../vnode/is-vnode":81,"../vnode/is-vtext":82,"../vnode/is-widget":83,"../vnode/vpatch":86,"./diff-props":88,"x-is-array":66}],90:[function(require,module,exports){
...
},{"./trie":92,"assert":4,"sliced":91}],91:[function(require,module,exports){
...
},{"assert":4,"xtend":93,"xtend/mutable":94}],93:[function(require,module,exports){
...
},{"./model":100,"./router":101,"./utils":102,"./view":103}],99:[function(require,module,exports){
"use strict";var duet=require("duet"),app=require("./app");duet(app,".todoapp",{isDebug:!0,isHashRouter:!0});


},{"./app":98,"duet":3}],100:[function(require,module,exports){
...
},{"./utils":102,"duet":3}],101:[function(require,module,exports){
...
},{"duet":3}],102:[function(require,module,exports){
...
},{"duet":3}],103:[function(require,module,exports){
...
},{"./Footer":95,"./Header":96,"./Main":97,"duet":3}]},{},[99]);
