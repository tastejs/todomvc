<section id="todoapp">
            ...
            <ul id="todo-list">
                ...
                <tpl for=".">
                    <li class="todo {[ values.completed ? "completed" : "" ]} {[ values.editing ? "editing" : "" ]}">
                        <div class="view">
                            <input class="toggle mousepointer" type="checkbox" {[ values.completed ? "checked" : ""]}>
                            <label>{ title }</label>
                            <button class="destroy mousepointer"></button>
                        </div>
    ...
    <tpl if="values.length">
        <footer id="footer">
            <span id="todo-count"><strong>{[ this.controller.incompleteCount() ]}</strong> items left</span>
