...
var AppView = (function () {
	function AppView() {
		...
		new Router({'/:filter': function (filter) {self.onRouterChange(filter);}}).init('/all');

		this.inputEl.addEventListener('keypress', function (e) {self.onInputKeyPress(e);});
		this.toggleAllBtn.addEventListener('click', function (e) {self.onTogglerAllBtnClick(e)});
		this.clearCompletedEl.addEventListener('click', function (e) {self.onClearCompletedClick()});
	}
