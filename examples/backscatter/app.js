...
/***/ function(module, exports, __webpack_require__) {
	...
	var _controllerApplication = __webpack_require__(1);

	var _controllerApplication2 = _interopRequireDefault(_controllerApplication);

	(0, _controllerApplication2["default"])(window);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backbone = __webpack_require__(166);
	...
	var _viewMain = __webpack_require__(159);

	var _viewMain2 = _interopRequireDefault(_viewMain);

	var _modelSession = __webpack_require__(164);

	var _modelSession2 = _interopRequireDefault(_modelSession);

	var _viewUrl = __webpack_require__(168);

	var _viewUrl2 = _interopRequireDefault(_viewUrl);

	exports['default'] = function (window) {

	    // Create default session
	    var session = new _modelSession2['default']();
	    session.get('tasks').set(JSON.parse(window.localStorage["todo-backscatter"] || "[]"));

	    // Add URL ("router") view
	    var urlView = new _viewUrl2['default']({ model: session, window: window });
	    urlView.on('url_change', _underscore2['default'].compose(session.set.bind(session, 'filter'), function (url) {
	        return ({ "active": "active", "completed": "completed" })[url] || "all";
	    }));

	    // Define render routine
	    var render = function render() {
	        _react2['default'].render(_react2['default'].createElement(_viewMain2['default'], {
	            tasks: session.get('tasks').toJSON(),
	            filter: session.get('filter'),
	            onAllTasksToggleCompleted: function onAllTasksToggleCompleted() {
	                return session.get('tasks').toggleCompleted();
	            },
	            onTaskToggleCompleted: function onTaskToggleCompleted(taskId) {
	                return session.get('tasks').get(taskId).toggleCompleted();
	            },
	            onTaskRename: function onTaskRename(taskId, newDescription) {
	                return session.get('tasks').get(taskId).set({ description: newDescription }, { validate: true });
	            },
	            onFilterChange: function onFilterChange(filter) {
	                return session.set({ filter: filter });
	            },
	            onTaskRemove: function onTaskRemove(taskId) {
	                return session.get('tasks').remove(session.get('tasks').get(taskId));
	            },
	            onTaskAdd: function onTaskAdd(description) {
	                session.get('tasks').add({ id: _underscore2['default'].uniqueId('task-'), description: description }, { validate: true });
	            },
	            onAllCompletedTasksRemove: function onAllCompletedTasksRemove() {
	                return session.get('tasks').removeCompleted();
	            }
	        }), document.getElementsByTagName('main')[0]);
	    };

	    // Define persistence routine
	    var persist = _underscore2['default'].debounce(function () {
	        return window.localStorage["todo-backscatter"] = JSON.stringify(session.get('tasks').toJSON());
	    }, 500);
	    ...
	    // ********************************************************************************************************************************
	    session.backscatterOn(_underscore2['default'].compose(persist, _underscore2['default'].debounce(render)))();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _taskList = __webpack_require__(160);
	...
	var _utilUtilities = __webpack_require__(162);
	            ...
	            return _react2['default'].createElement(
	                ...
	                [_react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement('input', { className: 'new-todo',
	                        ...
	                        onChange: function (e) {
	                            _this.setState({ newTaskDescription: e.target.value });
	                        },
	                        onKeyDown: function (_ref) {
	                            var which = _ref.which;
	                            var target = _ref.target;
	                            which === KEY_ENTER && (_this.props.onTaskAdd((0, _utilUtilities.trim)(target.value)) || _this.setState({ newTaskDescription: "" }));
	                        },
	                        autofocus: true })
	                )].concat(!this.props.tasks.length ? [] : [_react2['default'].createElement(
	                    'section',
	                    { key: 'main', className: 'main' },
	                    _react2['default'].createElement('input', { className: 'toggle-all', onChange: this.props.onAllTasksToggleCompleted,
	                        checked: this.props.tasks.filter(_underscore2['default'].matches({ completed: true })).length === this.props.tasks.length,
	                        type: 'checkbox' }),
	                    _react2['default'].createElement(_taskList2['default'], {
	                        filter: this.props.filter,
	                        tasks: this.props.tasks.map(function (task) {
	                            return _underscore2['default'].extend(task, {
	                                onToggleCompleted: _underscore2['default'].partial(_this.props.onTaskToggleCompleted, task.id),
	                                onRename: function onRename(newDescription) {
	                                    _this.props.onTaskRename(task.id, newDescription);
	                                },
	                                onRemove: _underscore2['default'].partial(_this.props.onTaskRemove, task.id)
	                            });
	                        }) })
	...
	Main.defaultProps = {
	    "tasks": [],
	    "filter": "all",
	    "onFilterChange": _underscore2['default'].noop,
	    "onTaskToggleCompleted": _underscore2['default'].noop,
	    "onTaskRename": _underscore2['default'].noop,
	    "onTaskRemove": _underscore2['default'].noop,
	    "onTaskAdd": _underscore2['default'].noop,
	    "onAllTasksToggleCompleted": _underscore2['default'].noop,
	    "onAllCompletedTasksRemove": _underscore2['default'].noop
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _taskItem = __webpack_require__(161);

	var _taskItem2 = _interopRequireDefault(_taskItem);

	var filters = {
	    "all": _underscore2['default'].constant(true),
	    "active": _underscore2['default'].matches({ completed: false }),
	    "completed": _underscore2['default'].matches({ completed: true })
	};
	...
	var TaskList = (function (_React$Component) {
	    ...
	    function TaskList() {
	        ...
	        _get(Object.getPrototypeOf(TaskList.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(TaskList, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'ul',
	                { className: 'todo-list' },
	                this.props.tasks.filter(filters[this.props.filter]).map(function (task, i) {
	                    return _react2['default'].createElement(_taskItem2['default'], _extends({ key: task.id }, task));
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskItem = (function (_React$Component) {
	    ...
	    _createClass(TaskItem, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'li',
	                { className: [this.props.completed && "completed", this.state.editing && "editing"].filter(Boolean).join(' ')
	                },
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'view' },
	                    ...
	                    _react2['default'].createElement(
	                        'label',
	                        { onDoubleClick: this.beginEditing.bind(this) },
	                        this.props.description
	                    ),
	                    _react2['default'].createElement('button', { onClick: this.props.onRemove, className: 'destroy' })
	                ),
	                _react2['default'].createElement('input', { className: 'edit',
	                    ref: 'editField',
	                    value: this.state.description,
	                    onChange: _underscore2['default'].compose(this.setState.bind(this), function (e) {
	        ...
	        key: 'renameAndEnd',
	        value: function renameAndEnd(event) {
	            var newDescription = (0, _utilUtilities.trim)(event.target.value);
	...
	TaskItem.defaultProps = {
	    ...
	    "description": "",
	    "completed": false,
	    "onRename": _underscore2['default'].noop,
	    "onToggleCompleted": _underscore2['default'].noop,
	    "onRemove": _underscore2['default'].noop
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getActiveItems = function getActiveItems(tasks) {
	    return _underscore2['default'].where(tasks, { completed: false });
	},
	    getCountText = function getCountText(number) {
	    return 'item' + (number - 1 ? "s" : "") + ' left';
	},
	    viewStates = [{ "id": "all", "caption": "All" }, { "id": "active", "caption": "Active" }, { "id": "completed", "caption": "Completed" }];
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    ' ',
	                    getCountText(activeItemsCount)
	                ),
	                _react2['default'].createElement(
	                    'ul',
	                    { className: 'filters' },
	                    viewStates.map(function (viewState) {
	                        return _react2['default'].createElement(
	                            'li',
	                            { key: viewState.id },
	                            _react2['default'].createElement(
	                                'button',
	                                {
	                                    onClick: _underscore2['default'].partial(_this.props.onFilterChange, viewState.id),
	                                    className: viewState.id === _this.props.filter ? "filter selected" : "filter" },
	                                viewState.caption
	                            )
	                        );
	                    })
	                ...
	                _react2['default'].createElement(
	                    'button',
	                    {
	                        style: { display: (0, _underscore2['default'])(this.props.tasks).chain().where({ completed: true }).some().value() ? "inline-block" : "none" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backscatter = __webpack_require__(165);

	var _task = __webpack_require__(167);

	var SessionModel = (function (_Model) {
	    _inherits(SessionModel, _Model);

	    function SessionModel() {
	        _classCallCheck(this, SessionModel);

	        _get(Object.getPrototypeOf(SessionModel.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(SessionModel, [{
	        ...
	        value: function defaults() {
	            return {
	                ...
	                "tasks": new _task.TaskCollection()
	            };
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory){
	    ...
	    if(true){
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(166)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskModel = (function (_Model) {
	    ...
	    function TaskModel() {
	        ...
	        _get(Object.getPrototypeOf(TaskModel.prototype), 'constructor', this).apply(this, arguments);
	    }
	...
	var TaskCollection = (function (_Collection) {
	    ...
	    function TaskCollection() {
	        ...
	        _get(Object.getPrototypeOf(TaskCollection.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(TaskCollection, [{
	        key: 'toggleCompleted',
	        value: function toggleCompleted() {
	            this.invoke('set', 'completed', _underscore2['default'].all(this.pluck('completed')) ? false : true);
	        }
	    }, {
	        key: 'removeCompleted',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var extractPath = function extractPath() {
	    return (window.location.hash.match(/\/?#\/?(.+?)$/) || [undefined, ""])[1];
	};

	var UrlView = (function (_View) {
	    _inherits(UrlView, _View);

	    function UrlView() {
	        _classCallCheck(this, UrlView);

	        _get(Object.getPrototypeOf(UrlView.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(UrlView, [{
	        key: '_setElement',
	        ...
	        value: function initialize(_ref) {
	            ...
	            window.addEventListener('hashchange', _underscore2['default'].compose(this.trigger.bind(this, 'url_change'), extractPath));
	            this.update();
	        }
	    }, {
	        key: 'update',
