      ...
      "Wrapper": {
        ...
        "SpeechBubble": {
          ...
          "Pointer": {
            props: {
              ...
              height: 13,
              border: {
                width: 13, style: "solid", color: LAY.transparent()
              },
        ...
        "Resources": {
          ...
          "Resource": {
            many: {
              rows: [
                {text: "Specification", link:"https://github.com/TheRelforFoundation/LAY.js/blob/master/specification.markdown"},
                {text: "Codepen", link: "http://codepen.io/collection/AEPxGb/"},
                {text: "Github", link: "https://github.com/TheRelforFoundation/LAY.js"}
              ],
              fargs:{onebelow:{gap:3}}
            },
            props: {
        ...
        "Issues": {
          props: {
            ...
            width: LAY.take("../", "width"),
            text: "If you have other helpful links to share, or find any of the links " +
              "above no longer work, please <a class='learn' href='https://github.com/tastejs/todomvc/issues'>let us know</a>.",
            textWrap: "normal",
            textStyle: "italic"
