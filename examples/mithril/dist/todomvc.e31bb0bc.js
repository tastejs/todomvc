    ...
    return (0, _mithril.default)("section.main", [(0, _mithril.default)("input.toggle-all[id='toggle-all'][type='checkbox']", {
      ...
      return (0, _mithril.default)("li.".concat(todo.status, ".").concat(todo.isEditing && "editing"), {
        ...
        onclick: function onclick() {
          return todo.status == "active" ? todo.status = "completed" : todo.status = "active";
        }
...
var Footer = {
  view: function view(_ref3) {
    ...
    var total = mdl.todos.filter(function (todo) {
      return todo.status == "active";
    }).length;
    return (0, _mithril.default)("footer.footer", [(0, _mithril.default)("span.todo-count", [(0, _mithril.default)("strong", "".concat(total, " ").concat(total == 1 ? "item" : "items"))]), (0, _mithril.default)("ul.filters", [(0, _mithril.default)("li", (0, _mithril.default)("a[href='#!/']", {
    ...
    }, "Completed"))]), mdl.todos.filter(function (todo) {
      return todo.status == "completed";
    }).length >= 1 && (0, _mithril.default)("button.clear-completed", {
      onclick: function onclick(_) {
        return mdl.todos.map(function (todo) {
          return todo.status = "active";
        });
...
var Layout = {
  view: function view(_ref4) {
    ...
    return (0, _mithril.default)("section.todoapp", [(0, _mithril.default)(Header, {
      mdl: mdl
...
var ToDoMvc = function ToDoMvc(mdl) {
  return {
    "/": {
...
_mithril.default.route(root, "/", ToDoMvc(mdl));
},{"mithril":"node_modules/mithril/index.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
