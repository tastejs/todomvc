...
(function (global){
function flush(){if("function"==typeof postMessageToUserThread)for(;queue.length;)postMessageToUserThread({type:"LOCAL_STORAGE::REQUEST",data:queue.shift()})}function getHandler(e){return handlers[e]}function getItem(e,t){var n=nextHandlerKey++;handlers[n]=function(e){t(e.value)},queue.push({handlerKey:n,key:e}),flush()}function setItem(e,t){queue.push({key:e,value:t}),flush()}function getOrSet(e,t){"function"==typeof valueOrFn?getItem(e,t):setItem(e,t)}function initAppThread(e){"function"!=typeof postMessageToUserThread&&(postMessageToUserThread=e,flush())}function initUserThread(e){"function"!=typeof postMessageToAppThread&&(postMessageToAppThread=e)}function onRequest(e){return e.value?void global.localStorage.setItem(e.key,e.value):postMessageToAppThread({type:"LOCAL_STORAGE::RESPONSE",data:{handlerKey:e.handlerKey,value:global.localStorage.getItem(e.key)}})}function onResponse(e){var t=getHandler(e.handlerKey);null!=t&&t(e)}function handleMessageType(e,t){var n=!1;switch(e){case"LOCAL_STORAGE::REQUEST":onRequest(t);break;case"LOCAL_STORAGE::RESPONSE":onResponse(t)}return n}var extend=require("xtend/mutable"),nextHandlerKey=0,handlers={},queue=[],postMessageToAppThread,postMessageToUserThread;module.exports=extend(getOrSet,{getItem:getItem,setItem:setItem,_initAppThread:initAppThread,_initUserThread:initUserThread,_handleMessageType:handleMessageType});


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"xtend/mutable":90}],10:[function(require,module,exports){
...
function appThread(e,a,n){function t(e){var a,n,t;a=p(e),n=vdom.diff(u,a),t=serialize(n),u=a,domEvent.cycleHandlers(),d({type:"DOM::PATCH",data:t})}function i(e,a,n){if(p)throw new Error("tried to initialise app more than once");p=e,u=vdom.h("div"),t(a()),a(t),f=n,o(m)}function r(e){m=e,a(i)}function o(e){var a,t;"function"==typeof f&&(n.isHashRouter?(t=e.split("#"),t.length>1&&(t.shift(),a=hashMatch("#".concat(t.join("#"))))):(a=pathnameMatch(e),a.length||(a="/")),a&&f(a))}function s(e){var a=domEvent.getHandler(e.handlerKey);null!=a&&a(e)}function h(e,a){n.bridges.some(function(n){return"function"==typeof n._handleMessageType?n._handleMessageType(e,a):void 0})}function c(e,a){switch(e){case"INIT":r(a);break;case"LOCATION":o(a);break;case"DOM::EVENT":s(a);break;default:h(e,a)}}var d,u,p,f,m;d=e.postMessage.bind(e),e.onmessage=msg(c,n.isDebug),n.bridges.forEach(function(e){"function"==typeof e._initAppThread&&e._initAppThread(d)})}var vdom=require("virtual-dom"),serialize=require("vdom-serialized-patch/serialize"),pathnameMatch=require("pathname-match"),hashMatch=require("hash-match"),msg=require("./msg"),domEvent=require("./domEvent");module.exports=appThread;


},{"./domEvent":13,"./msg":17,"hash-match":23,"pathname-match":33,"vdom-serialized-patch/serialize":51,"virtual-dom":55}],12:[function(require,module,exports){
...
},{"hyperstyles":24,"hyperx":26,"virtual-dom":55,"xtend/mutable":90}],13:[function(require,module,exports){
...
},{"./domEventNames":14,"xtend/mutable":90}],14:[function(require,module,exports){
...
(function (global){
function duet(e,r,o){var a;if(o="object"==typeof o&&null!==o&&o||{},o.bridges=Array.isArray(o.bridges)&&o.bridges||[],!o.forceSingleThread){if(WORKER_ENABLED)return userThread(new global.Worker(PATHNAME),r,o);if(IN_WORKER_CONTEXT)return appThread(global.self,e,o)}a=new SingleThread,userThread(a.worker,r,o),appThread(a.self,e,o)}function getPathname(){var e,r;return e=global.document.getElementsByTagName("script"),r=e[e.length-1].src,new global.URL(r).pathname}var extend=require("xtend/mutable"),userThread=require("./userThread"),appThread=require("./appThread"),SingleThread=require("./SingleThread"),dom=require("./dom"),domEvent=require("./domEvent"),model=require("./model"),router=require("./router"),WORKER_ENABLED=!(global!==global.window||!global.URL||!global.Worker),IN_WORKER_CONTEXT=!(global!==global.self||!global.location),PATHNAME=WORKER_ENABLED&&getPathname();module.exports=extend(duet,{dom:dom,domFor:dom.domFor,domEvent:domEvent,event:domEvent,ev:domEvent,model:model,modelFor:model.modelFor,struct:model.struct,varhash:model.varhash,value:model.value,router:router});


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./SingleThread":10,"./appThread":11,"./dom":12,"./domEvent":13,"./model":16,"./router":18,"./userThread":19,"xtend/mutable":90}],16:[function(require,module,exports){
...
},{"./domEvent":13,"observ":32,"observ-struct":28,"observ-varhash":30,"xtend/mutable":90}],17:[function(require,module,exports){
function msg(a,t){return function(e){return t&&console.debug(e.data.type,e.data.data),a(e.data.type,e.data.data)}}var console=require("console");module.exports=msg;


},{"console":3}],18:[function(require,module,exports){
module.exports=require("wayfarer");


},{"wayfarer":86}],19:[function(require,module,exports){
function userThread(e,t,n){function o(e,t){function n(e,n){var o=t[n];return n.charAt(0)!==n.charAt(0).toLowerCase()||"number"!=typeof o&&"string"!=typeof o&&"boolean"!=typeof o||(e[n]=o),e}var o,a,r;o=t.target.dataset[e],"string"==typeof o&&(a=Object.keys(t.constructor.prototype).reduce(n,{}),r=getFormData(t.target),new RegExp("\\b"+e+"\\b").test(t.target.dataset["default"])||t.preventDefault(),s({type:"DOM::EVENT",data:{handlerKey:o,eventName:e,eventData:a,formData:r}}))}function a(e){m[e]=o.bind(null,e),l.addEventListener(e,m[e])}function r(e){l.removeEventListener(e,m[e]),delete m[e]}function i(e){function t(e){Object.keys(e.dataset).forEach(n)}function n(e){domEventNames.indexOf(e)>-1&&i.indexOf(e)<0&&i.push(e)}function o(e){i.indexOf(e)>-1&&null==m[e]?a(e):i.indexOf(e)<0&&null!=m[e]&&r(e)}var i,c;patch(l,e),setTimeout(function(){i=[],concat.apply(l,l.querySelectorAll("*")).forEach(t),domEventNames.forEach(o),c=l.querySelector("[autofocus]"),null!=c&&document.activeElement!==c&&c.focus()},0)}function c(e){window.requestAnimationFrame(i.bind(null,e))}function u(e,t){n.bridges.some(function(n){return"function"==typeof n._handleMessageType?n._handleMessageType(e,t):void 0})}function d(e,t){switch(e){case"DOM::PATCH":c(t);break;default:u(e,t)}}var s,f,l,m;if(s=e.postMessage.bind(e),f=document.querySelector(t),null==f)throw new Error("selector did not match an element");l=document.createElement("div"),f.insertBefore(l,f.firstChild),m={},window.onclick=function(e){"a"===e.target.localName&&void 0!==e.target.href&&window.location.host===e.target.host&&(e.preventDefault(),s({type:"LOCATION",data:e.target.href}),window.history.pushState({},null,e.target.href))},window.onpopstate=function(){s({type:"LOCATION",data:document.location.href})},e.onmessage=msg(d,n.isDebug),n.bridges.forEach(function(e){"function"==typeof e._initUserThread&&e._initUserThread(s)}),s({type:"INIT",data:document.location.href})}var getFormData=require("form-data-set/element"),patch=require("vdom-serialized-patch/patch"),concat=Array.prototype.concat,msg=require("./msg"),domEventNames=require("./domEvent").domEventNames;module.exports=userThread;


},{"./domEvent":13,"./msg":17,"form-data-set/element":20,"vdom-serialized-patch/patch":50}],20:[function(require,module,exports){
...
},{"./transform":25}],25:[function(require,module,exports){
...
function quot(T){return T===ATTR_VALUE_SQ||T===ATTR_VALUE_DQ}function has(T,e){return hasOwn.call(T,e)}function selfClosing(T){return closeRE.test(T)}var attrToProp=require("hyperscript-attribute-to-property"),VAR=0,TEXT=1,OPEN=2,CLOSE=3,ATTR=4,ATTR_KEY=5,ATTR_KEY_W=6,ATTR_VALUE_W=7,ATTR_VALUE=8,ATTR_VALUE_SQ=9,ATTR_VALUE_DQ=10,ATTR_EQ=11,ATTR_BREAK=12;module.exports=function(T,e){function A(T){return"function"==typeof T?T:"string"==typeof T?T:T&&"object"==typeof T?T:t("",T)}T=attrToProp(T),e||(e={});var t=e.concat||function(T,e){return String(T)+String(e)};return function(e){function r(T){var e=[];n===ATTR_VALUE_W&&(n=ATTR);for(var A=0;A<T.length;A++){var t=T.charAt(A);n===TEXT&&"<"===t?(R.length&&e.push([TEXT,R]),R="",n=OPEN):">"!==t||quot(n)?n===TEXT?R+=t:n===OPEN&&/\s/.test(t)?(e.push([OPEN,R]),R="",n=ATTR):n===OPEN?R+=t:n===ATTR&&/[\w-]/.test(t)?(n=ATTR_KEY,R=t):n===ATTR&&/\s/.test(t)?(R.length&&e.push([ATTR_KEY,R]),e.push([ATTR_BREAK])):n===ATTR_KEY&&/\s/.test(t)?(e.push([ATTR_KEY,R]),R="",n=ATTR_KEY_W):n===ATTR_KEY&&"="===t?(e.push([ATTR_KEY,R],[ATTR_EQ]),R="",n=ATTR_VALUE_W):n===ATTR_KEY?R+=t:n!==ATTR_KEY_W&&n!==ATTR||"="!==t?n!==ATTR_KEY_W&&n!==ATTR||/\s/.test(t)?n===ATTR_VALUE_W&&'"'===t?n=ATTR_VALUE_DQ:n===ATTR_VALUE_W&&"'"===t?n=ATTR_VALUE_SQ:n===ATTR_VALUE_DQ&&'"'===t?(e.push([ATTR_VALUE,R],[ATTR_BREAK]),R="",n=ATTR):n===ATTR_VALUE_SQ&&"'"===t?(e.push([ATTR_VALUE,R],[ATTR_BREAK]),R="",n=ATTR):n!==ATTR_VALUE_W||/\s/.test(t)?n===ATTR_VALUE&&/\s/.test(t)?(e.push([ATTR_BREAK],[ATTR_VALUE,R]),R="",n=ATTR):(n===ATTR_VALUE||n===ATTR_VALUE_SQ||n===ATTR_VALUE_DQ)&&(R+=t):(n=ATTR_VALUE,A--):(e.push([ATTR_BREAK]),/[\w-]/.test(t)?(R+=t,n=ATTR_KEY):n=ATTR):(e.push([ATTR_EQ]),n=ATTR_VALUE_W):(n===OPEN?e.push([OPEN,R]):n===ATTR_KEY?e.push([ATTR_KEY,R]):n===ATTR_VALUE&&R.length&&e.push([ATTR_VALUE,R]),e.push([CLOSE]),R="",n=TEXT)}return n===TEXT&&R.length?(e.push([TEXT,R]),R=""):n===ATTR_VALUE&&R.length?(e.push([ATTR_VALUE,R]),R=""):n===ATTR_VALUE_DQ&&R.length?(e.push([ATTR_VALUE,R]),R=""):n===ATTR_VALUE_SQ&&R.length?(e.push([ATTR_VALUE,R]),R=""):n===ATTR_KEY&&(e.push([ATTR_KEY,R]),R=""),e}for(var n=TEXT,R="",E=arguments.length,s=[],_=0;_<e.length;_++)if(E-1>_){var o=arguments[_+1],l=r(e[_]),f=n;f===ATTR_VALUE_DQ&&(f=ATTR_VALUE),f===ATTR_VALUE_SQ&&(f=ATTR_VALUE),f===ATTR_VALUE_W&&(f=ATTR_VALUE),f===ATTR&&(f=ATTR_KEY),l.push([VAR,f,o]),s.push.apply(s,l)}else s.push.apply(s,r(e[_]));for(var h=[null,{},[]],i=[[h,-1]],_=0;_<s.length;_++){var a=i[i.length-1][0],l=s[_],p=l[0];if(p===OPEN&&/^\//.test(l[1])){var u=i[i.length-1][1];i.length>1&&(i.pop(),i[i.length-1][0][2][u]=T(a[0],a[1],a[2].length?a[2]:void 0))}else if(p===OPEN){var g=[l[1],{},[]];a[2].push(g),i.push([g,a[2].length-1])}else if(p===ATTR_KEY||p===VAR&&l[1]===ATTR_KEY){for(var L,V="";_<s.length;_++)if(s[_][0]===ATTR_KEY)V=t(V,s[_][1]);else{if(s[_][0]!==VAR||s[_][1]!==ATTR_KEY)break;if("object"!=typeof s[_][2]||V)V=t(V,s[_][2]);else for(L in s[_][2])s[_][2].hasOwnProperty(L)&&!a[1][L]&&(a[1][L]=s[_][2][L])}s[_][0]===ATTR_EQ&&_++;for(var U=_;_<s.length;_++)if(s[_][0]===ATTR_VALUE||s[_][0]===ATTR_KEY)a[1][V]?a[1][V]=t(a[1][V],s[_][1]):a[1][V]=A(s[_][1]);else{if(s[_][0]!==VAR||s[_][1]!==ATTR_VALUE&&s[_][1]!==ATTR_KEY){!V.length||a[1][V]||_!==U||s[_][0]!==CLOSE&&s[_][0]!==ATTR_BREAK||(a[1][V]=V.toLowerCase());break}a[1][V]?a[1][V]=t(a[1][V],s[_][2]):a[1][V]=A(s[_][2])}}else if(p===ATTR_KEY)a[1][l[1]]=!0;else if(p===VAR&&l[1]===ATTR_KEY)a[1][l[2]]=!0;else if(p===CLOSE){if(selfClosing(a[0])&&i.length){var u=i[i.length-1][1];i.pop(),i[i.length-1][0][2][u]=T(a[0],a[1],a[2].length?a[2]:void 0)}}else if(p===VAR&&l[1]===TEXT)void 0===l[2]||null===l[2]?l[2]="":l[2]||(l[2]=t("",l[2])),Array.isArray(l[2][0])?a[2].push.apply(a[2],l[2]):a[2].push(l[2]);else if(p===TEXT)a[2].push(l[1]);else if(p!==ATTR_EQ&&p!==ATTR_BREAK)throw new Error("unhandled: "+p)}if(h[2].length>1&&/^\s*$/.test(h[2][0])&&h[2].shift(),h[2].length>2||2===h[2].length&&/\S/.test(h[2][1]))throw new Error("multiple root elements must be wrapped in an enclosing tag");return Array.isArray(h[2][0])&&"string"==typeof h[2][0][0]&&Array.isArray(h[2][0][2])&&(h[2][0]=T(h[2][0][0],h[2][0][1],h[2][0][2])),h[2][0]}};var hasOwn=Object.prototype.hasOwnProperty,closeRE=RegExp("^("+["area","base","basefont","bgsound","br","col","command","embed","frame","hr","img","input","isindex","keygen","link","meta","param","source","track","wbr","animate","animateTransform","circle","cursor","desc","ellipse","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence","font-face-format","font-face-name","font-face-uri","glyph","glyphRef","hkern","image","line","missing-glyph","mpath","path","polygon","polyline","rect","set","stop","tref","use","view","vkern"].join("|")+")(?:[.#][a-zA-Z0-9-￿_:-]+)*$");
...
},{"observ":32,"xtend":29}],29:[function(require,module,exports){
...
function ObservVarhash(e,t){t=t||function(e){return e};var r={},n=NO_TRANSACTION,s=Observ(r);setNonEnumerable(s,"_removeListeners",{}),setNonEnumerable(s,"set",s.set),setNonEnumerable(s,"get",get.bind(s)),setNonEnumerable(s,"put",put.bind(s,t,n)),setNonEnumerable(s,"delete",del.bind(s));for(var i in e)s[i]="function"==typeof e[i]?e[i]:t(e[i],i),isFn(s[i])&&(s._removeListeners[i]=s[i](watch(s,i,n)));var o={};for(i in e){var a=s[i];checkKey(i),o[i]=isFn(a)?a():a}return s.set(o),s(function(t){if(n!==t)for(var r in e){var s=e[r];isFn(s)&&s()!==t[r]&&s.set(t[r])}}),s}function get(e){return this[e]}function put(e,t,r,n){if(checkKey(r),void 0===n)throw new Error("cannot varhash.put(key, undefined).");var s="function"==typeof n?n:e(n,r),i=extend(this());return i[r]=isFn(s)?s():s,isFn(this._removeListeners[r])&&this._removeListeners[r](),this._removeListeners[r]=isFn(s)?s(watch(this,r,t)):null,setNonEnumerable(i,"_diff",diff(r,i[r])),this[r]=s,this.set(i),this}function del(e){var t=extend(this());return isFn(this._removeListeners[e])&&this._removeListeners[e](),delete this._removeListeners[e],delete t[e],delete this[e],setNonEnumerable(t,"_diff",diff(e,void 0)),this.set(t),this}function watch(e,t,r){return function(n){var s=extend(e());s[t]=n,setNonEnumerable(s,"_diff",diff(t,n)),r=s,e.set(s),r=NO_TRANSACTION}}function diff(e,t){var r={};return r[e]=t&&t._diff?t._diff:t,r}function isFn(e){return"function"==typeof e}function setNonEnumerable(e,t,r){Object.defineProperty(e,t,{value:r,writable:!0,configurable:!0,enumerable:!1})}function checkKey(e){if(blacklist[e])throw new Error("cannot create an observ-varhash with key `"+e+"`. "+blacklist[e])}var Observ=require("observ"),extend=require("xtend"),NO_TRANSACTION={};module.exports=ObservVarhash;var blacklist={name:"Clashes with `Function.prototype.name`.",get:"get is a reserved key of observ-varhash method",put:"put is a reserved key of observ-varhash method","delete":"delete is a reserved key of observ-varhash method",_diff:"_diff is a reserved key of observ-varhash method",_removeListeners:"_removeListeners is a reserved key of observ-varhash"};


},{"observ":32,"xtend":31}],31:[function(require,module,exports){
function extend(){for(var r={},e=0;e<arguments.length;e++){var n=arguments[e];for(var t in n)n.hasOwnProperty(t)&&(r[t]=n[t])}return r}module.exports=extend;
...
function match(e){return assert.equal(typeof e,"string"),e.trim().replace(/[\?|#].*$/,"").replace(/^(?:https?\:)\/\//,"").replace(/^(?:[\w.])+(?:[\:0-9]{4,5})?/,"").replace(/\/$/,"")}const assert=require("assert");module.exports=match;
...
},{"./isObject":38,"./isSoftSetHook":39}],35:[function(require,module,exports){
...
},{"./applyProperties":34,"./isVNode":40,"./isVText":41}],36:[function(require,module,exports){
...
},{"./patchRecursive":43}],38:[function(require,module,exports){
...
},{"./types":44}],41:[function(require,module,exports){
...
},{"../patchTypes":45,"./applyProperties":34,"./createElement":35}],43:[function(require,module,exports){
...
},{"./domIndex":36,"./patchOp":42}],44:[function(require,module,exports){
...
},{"../patchTypes":45,"vdom-as-json/toJson":49}],47:[function(require,module,exports){
...
},{"./types":48,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":71}],48:[function(require,module,exports){
module.exports={VirtualTree:1,VirtualPatch:2,VirtualNode:3,SoftSetHook:4};
...
},{"./lib/toJson":47}],50:[function(require,module,exports){
module.exports=require("./lib/patch");


},{"./lib/patch":37}],51:[function(require,module,exports){
module.exports=require("./lib/serialize");


},{"./lib/serialize":46}],52:[function(require,module,exports){
var createElement=require("./vdom/create-element.js");module.exports=createElement;


},{"./vdom/create-element.js":65}],53:[function(require,module,exports){
var diff=require("./vtree/diff.js");module.exports=diff;


},{"./vtree/diff.js":85}],54:[function(require,module,exports){
var h=require("./virtual-hyperscript/index.js");module.exports=h;


},{"./virtual-hyperscript/index.js":72}],55:[function(require,module,exports){
...
},{"./create-element.js":52,"./diff.js":53,"./h.js":54,"./patch.js":63,"./vnode/vnode.js":81,"./vnode/vtext.js":83}],56:[function(require,module,exports){
...
},{"individual/one-version":59}],58:[function(require,module,exports){
(function (global){
...
},{"min-document":2}],61:[function(require,module,exports){
"use strict";module.exports=function(t){return"object"==typeof t&&null!==t};
...
},{"../vnode/is-vhook.js":76,"is-object":61}],65:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":74,"../vnode/is-vnode.js":77,"../vnode/is-vtext.js":78,"../vnode/is-widget.js":79,"./apply-properties":64,"global/document":60}],66:[function(require,module,exports){
...
},{"./create-element":65,"./dom-index":66,"./patch-op":67,"global/document":60,"x-is-array":62}],69:[function(require,module,exports){
...
},{"ev-store":57}],71:[function(require,module,exports){
...
},{"../vnode/is-thunk":75,"../vnode/is-vhook":76,"../vnode/is-vnode":77,"../vnode/is-vtext":78,"../vnode/is-widget":79,"../vnode/vnode.js":81,"../vnode/vtext.js":83,"./hooks/ev-hook.js":70,"./hooks/soft-set-hook.js":71,"./parse-tag.js":73,"x-is-array":62}],73:[function(require,module,exports){
...
},{"browser-split":56}],74:[function(require,module,exports){
...
},{"../vnode/is-vhook":76,"is-object":61}],85:[function(require,module,exports){
...
},{"../vnode/handle-thunk":74,"../vnode/is-thunk":75,"../vnode/is-vnode":77,"../vnode/is-vtext":78,"../vnode/is-widget":79,"../vnode/vpatch":82,"./diff-props":84,"x-is-array":62}],86:[function(require,module,exports){
...
},{"./trie":88,"assert":1,"sliced":87}],87:[function(require,module,exports){
...
"use strict";function _taggedTemplateLiteral(e,t){return Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}var _templateObject=_taggedTemplateLiteral(["\n    <footer class=",'>\n      <span class="todo-count"></span>\n      <ul class="filters">\n        <li><a class=',' href="/#/">All</a></li>\n        <li><a class=',' href="/#/active">Active</a></li>\n        <li><a class=',' href="/#/completed">Completed</a></li>\n      </ul>\n      <button\n        class=',"\n        dataset=",">Clear completed</button>\n    </footer>\n  "],["\n    <footer class=",'>\n      <span class="todo-count"></span>\n      <ul class="filters">\n        <li><a class=',' href="/#/">All</a></li>\n        <li><a class=',' href="/#/active">Active</a></li>\n        <li><a class=',' href="/#/completed">Completed</a></li>\n      </ul>\n      <button\n        class=',"\n        dataset=",">Clear completed</button>\n    </footer>\n  "]),_require=require("duet"),dom=_require.dom,modelFor=_require.modelFor;module.exports=function(e){var t=modelFor(e),l=Object.keys(e.todos),o=function(t){return e.filter===t?"selected":""},a=function(e){l.forEach(function(t){e.todos.get(t).completed&&e.todos["delete"](t)})},n=l.reduce(function(t,l){return e.todos[l].completed?t+1:t},0);return dom(_templateObject,"footer"+(l.length?"":" hidden"),o("all"),o("active"),o("completed"),"clear-completed"+(n?"":" hidden"),{click:t.ev(a)})};


},{"duet":15}],92:[function(require,module,exports){
"use strict";function _taggedTemplateLiteral(e,t){return Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}var _templateObject=_taggedTemplateLiteral(['\n    <header class="header">\n      <h1>todos</h1>\n      <input type="text"\n        class="new-todo"\n        name="new-todo"\n        value=',"\n        dataset=",'\n        placeholder="What needs to be done?"\n        '," />\n    </header>\n  "],['\n    <header class="header">\n      <h1>todos</h1>\n      <input type="text"\n        class="new-todo"\n        name="new-todo"\n        value=',"\n        dataset=",'\n        placeholder="What needs to be done?"\n        '," />\n    </header>\n  "]),_require=require("duet"),dom=_require.dom,modelFor=_require.modelFor,_require2=require("../utils"),uuid=_require2.uuid,ENTER_KEY=13,onKeydown=function(e,t){var n;t.event.keyCode===ENTER_KEY&&(n=t.form["new-todo"].trim(),n&&(e.todos.put(uuid(),{title:n,completed:!1}),e.newTodo.set("")))};module.exports=function(e){var t=modelFor(e);return dom(_templateObject,e.newTodo,{keydown:t.ev(onKeydown),"default":"keydown"},e.isInitLoad?"autofocus":"")};


},{"../utils":98,"duet":15}],93:[function(require,module,exports){
"use strict";function _taggedTemplateLiteral(e,t){return Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}var _templateObject=_taggedTemplateLiteral(["\n      <li class="," key=",'>\n        <div class="view">\n          <input type="checkbox"\n            class="toggle"\n            key=',"\n            ","\n            dataset="," />\n          <label dataset=",">",'</label>\n          <button class="destroy" dataset=','></button>\n        </div>\n        <input type="text"\n          class="edit"\n          name="title"\n          value=',"\n          dataset=","\n          "," />\n      </li>\n    "],["\n      <li class="," key=",'>\n        <div class="view">\n          <input type="checkbox"\n            class="toggle"\n            key=',"\n            ","\n            dataset="," />\n          <label dataset=",">",'</label>\n          <button class="destroy" dataset=','></button>\n        </div>\n        <input type="text"\n          class="edit"\n          name="title"\n          value=',"\n          dataset=","\n          "," />\n      </li>\n    "]),_templateObject2=_taggedTemplateLiteral(["\n    <section class=",'>\n      <input type="checkbox"\n        class="toggle-all"\n        key=',"\n        ","\n        dataset=",' />\n      <label for="toggle-all">Mark all as complete</label>\n      <ul class="todo-list">\n        ',"\n      </ul>\n    </section>\n  "],["\n    <section class=",'>\n      <input type="checkbox"\n        class="toggle-all"\n        key=',"\n        ","\n        dataset=",' />\n      <label for="toggle-all">Mark all as complete</label>\n      <ul class="todo-list">\n        ',"\n      </ul>\n    </section>\n  "]),_require=require("duet"),dom=_require.dom,modelFor=_require.modelFor,_require2=require("../utils"),extend=_require2.extend,_require3=require("duet/node_modules/virtual-dom"),create=_require3.create,ENTER_KEY=13,ESCAPE_KEY=27;module.exports=function(e){var t=modelFor(e),n=Object.keys(e.todos),l=function(t){var l=Object.keys(t().todos).reduce(function(t,n){return e.todos[n].completed?t:t+1},0);n.forEach(function(e){var n=t.todos.get(e);t.todos.put(e,extend(n,{completed:l>0}))})},o=function(e,t){var n=t.custom,l=e.todos.get(n);e.todos.put(n,extend(l,{completed:!l.completed}))},a=function(e,t){e.editing.set(t.custom)},c=function(e,t){e.todos["delete"](t.custom)},d=function(e,t){var n=t.custom,l=void 0,o=void 0;return t.event.keyCode===ESCAPE_KEY?void e.editing.set(null):void(t.event.keyCode===ENTER_KEY&&(l=t.form.title,o=e.todos.get(n),console.log(l),e.todos.put(n,extend(o,{title:l})),e.editing.set(null)))},i=function(e){e.editing.set(null)},s=n.reduce(function(t,n){return e.todos[n].completed?t:t+1},0),r=(n.length-s,n.filter(function(t){var n=e.todos[t];switch(e.filter){case"completed":return n.completed;case"active":return!n.completed;default:return!0}})),u=function(n){var l=e.todos[n];return dom(_templateObject,e.editing===n?"editing":"","todo--"+n,"toggle--"+n+(l.completed?"--checked":""),l.completed?"checked":"",{change:t.ev(o,n)},{dblclick:t.ev(a,n)},l.title,{click:t.ev(c,n)},l.title,{keydown:t.ev(d,n),focusout:t.ev(i),"default":"keydown"},e.editing===n?"autofocus":"")};return dom(_templateObject2,"main"+(n.length?"":" hidden"),"toggle-all"+(0===s?"--checked":""),0===s?"checked":"",{change:t.ev(l)},r.map(u))};


},{"../utils":98,"duet":15,"duet/node_modules/virtual-dom":55}],94:[function(require,module,exports){
...
},{"./model":96,"./router":97,"./utils":98,"./view":99}],95:[function(require,module,exports){
"use strict";var duet=require("duet"),app=require("./app");duet(app,".todoapp",{bridges:[require("duet/bridges/local-storage")],isDebug:!0,isHashRouter:!0});


},{"./app":94,"duet":15,"duet/bridges/local-storage":9}],96:[function(require,module,exports){
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},_require=require("duet"),model=_require.model,value=_require.value,varhash=_require.varhash,_require2=require("./utils"),store=_require2.store,Todo=function(e,o){var t=e.title,r=e.completed;return{title:t,completed:r}};module.exports=function(e){var o=null!=e&&"object"===("undefined"==typeof e?"undefined":_typeof(e))&&e||{},t=model({isInitLoad:value(!0),todos:varhash(o,Todo),newTodo:value(""),editing:value(null),filter:value("all")}),r=t(function(e){e.isInitLoad&&(r(),t.isInitLoad.set(!1))});return t.todos(function(e){store("todos-duet",e)}),t};


},{"./utils":98,"duet":15}],97:[function(require,module,exports){
...
},{"duet":15}],98:[function(require,module,exports){
"use strict";var localStorage=require("duet/bridges/local-storage"),uuid=function r(){for(var r="",t=0;32>t;t++){var e=16*Math.random()|0;(8===t||12===t||16===t||20===t)&&(r+="-"),r+=(12===t?4:16===t?3&e|8:e).toString(16)}return r},store=function(r,t){return"function"==typeof t?localStorage.getItem(r,function(r){t(r&&JSON.parse(r)||[])}):localStorage.setItem(r,JSON.stringify(t))},hasOwnProperty=Object.prototype.hasOwnProperty,extend=function(){for(var r=arguments.length,t=Array(r),e=0;r>e;e++)t[e]=arguments[e];for(var o={},n=0;n<t.length;n++){var a=t[n];for(var u in a)hasOwnProperty.call(a,u)&&(o[u]=a[u])}return o};module.exports={uuid:uuid,store:store,extend:extend};


},{"duet/bridges/local-storage":9}],99:[function(require,module,exports){
...
},{"./Footer":91,"./Header":92,"./Main":93,"duet":15}]},{},[95]);
