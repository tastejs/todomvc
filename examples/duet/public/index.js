...
},{"./domEvent":5,"./localStorage":8,"./msg":10,"hash-match":37,"pathname-match":47,"vdom-serialized-patch/serialize":65,"virtual-dom":69}],3:[function(require,module,exports){
...
},{"csjs":23,"xtend/mutable":104}],4:[function(require,module,exports){
...
},{"hyperstyles":38,"hyperx":40,"virtual-dom":69,"xtend/mutable":104}],5:[function(require,module,exports){
...
},{"./domEventNames":6,"xtend/mutable":104}],6:[function(require,module,exports){
...
},{"./SingleThread":1,"./appThread":2,"./css":3,"./dom":4,"./domEvent":5,"./localStorage":8,"./model":9,"./router":11,"./userThread":12,"xtend/mutable":104}],8:[function(require,module,exports){
...
},{"xtend/mutable":104}],9:[function(require,module,exports){
...
},{"./domEvent":5,"observ":46,"observ-struct":42,"observ-varhash":44,"xtend/mutable":104}],10:[function(require,module,exports){
...
},{"wayfarer":100}],12:[function(require,module,exports){
function userThread(e,t,a){function n(t,a){function n(e,t){var n=a[t];return t.charAt(0)!==t.charAt(0).toLowerCase()||"number"!=typeof n&&"string"!=typeof n&&"boolean"!=typeof n||(e[t]=n),e}var o,r,s;o=a.target.dataset[t],"string"==typeof o&&(r=Object.keys(a.constructor.prototype).reduce(n,{}),s=getFormData(a.target),new RegExp("\\b"+t+"\\b").test(a.target.dataset["default"])||a.preventDefault(),e.postMessage({type:"DOM_EVENT",data:{handlerKey:o,eventName:t,eventData:r,formData:s}}))}function o(e){m[e]=n.bind(null,e),f.addEventListener(e,m[e])}function r(e){f.removeEventListener(e,m[e]),delete m[e]}function s(e){function t(e){Object.keys(e.dataset).forEach(a)}function a(e){domEventNames.indexOf(e)>-1&&s.indexOf(e)<0&&s.push(e)}function n(e){s.indexOf(e)>-1&&null==m[e]?o(e):s.indexOf(e)<0&&null!=m[e]&&r(e)}var s,c;patch(f,e),setTimeout(function(){s=[],concat.apply(f,f.querySelectorAll("*")).forEach(t),domEventNames.forEach(n),c=f.querySelector("[autofocus]"),null!=c&&document.activeElement!==c&&c.focus()},0)}function c(e){window.requestAnimationFrame(s.bind(null,e))}function i(t){return t.value?void localStorage.setItem(t.key,t.value):e.postMessage({type:"LOCAL_STORAGE",data:{handlerKey:t.handlerKey,value:localStorage.getItem(t.key)}})}function u(e){insertCSS(e)}function l(e,t){switch(e){case"DOM_PATCH":c(t);break;case"LOCAL_STORAGE":i(t);break;case"CSS":u(t)}}var d,f,m;if(d=document.querySelector(t),null==d)throw new Error("selector did not match an element");f=document.createElement("div"),d.insertBefore(f,d.firstChild),m={},window.onclick=function(t){"a"===t.target.localName&&void 0!==t.target.href&&window.location.host===t.target.host&&(t.preventDefault(),e.postMessage({type:"LOCATION",data:t.target.href}),window.history.pushState({},null,t.target.href))},window.onpopstate=function(){e.postMessage({type:"LOCATION",data:document.location.href})},e.onmessage=msg(l,a.isDebug&&"APP"),e.postMessage({type:"READY",data:document.location.href})}var insertCSS=require("insert-css"),getFormData=require("form-data-set/element"),patch=require("vdom-serialized-patch/patch"),concat=Array.prototype.concat,slice=Array.prototype.slice,msg=require("./msg"),domEventNames=require("./domEvent").domEventNames;module.exports=userThread;


},{"./domEvent":5,"./msg":10,"form-data-set/element":34,"insert-css":41,"vdom-serialized-patch/patch":64}],13:[function(require,module,exports){
...
"use strict";var csjs=require("./csjs");module.exports=csjs,module.exports.csjs=csjs,module.exports.getCss=require("./get-css");
...
"use strict";function getClassChain(n){function e(n){return Object.keys(n).forEach(function(r){t[r]||(t[r]=!0,o.push(r),e(n[r]))})}var t={},o=[];return e(n),o}var makeComposition=require("./composition").makeComposition;module.exports=function(n,e,t){var o=Object.keys(e).reduce(function(n,t){var o=e[t];return n[o]=makeComposition([t],[o],!0),n},{}),r=Object.keys(n).reduce(function(e,o){var r=n[o],i=t[o],u=i?getClassChain(i):[],c=[o].concat(u),a=c.map(function(e){return n[e]?n[e]:e});return e[r]=makeComposition(c,a),e},o);return r};
...
"use strict";function selectorize(e){return isComposition(e)?e.selector:e}function joiner(e,s){return e.map(function(e,t){return t!==s.length?e+s[t]:e}).join("")}function without(e,s){return Object.keys(e).reduce(function(t,r){return s[r]||(t[r]=e[r]),t},{})}var extractExtends=require("./css-extract-extends"),isComposition=require("./composition").isComposition,buildExports=require("./build-exports"),scopify=require("./scopeify"),cssKey=require("./css-key");module.exports=function(e){var s=Array.prototype.slice.call(arguments,1),t=joiner(e,s.map(selectorize)),r=s.reduce(function(e,s){return isComposition(s)&&s.classNames.forEach(function(t,r){e[t]=s.unscoped[r]}),e},{}),i=scopify(t,r),o=Object.assign({},i.classes,i.keyframes),n=extractExtends(i.css,o),c=without(i.classes,r),u=without(i.keyframes,r),a=n.compositions,p=buildExports(c,u,a);return Object.defineProperty(p,cssKey,{enumerable:!1,configurable:!1,writeable:!1,value:n.css})};


},{"./build-exports":25,"./composition":26,"./css-extract-extends":28,"./css-key":29,"./scopeify":33}],28:[function(require,module,exports){
"use strict";function splitter(s){return s.split(",").map(getClassName)}function getClassName(s){var o=s.trim();return"."===o[0]?o.substr(1):o}var makeComposition=require("./composition").makeComposition,regex=/(.*?)(\s+?)(extends\s+?)((?:.|\n)*?){(?:(?:.|\n)*?)}/g;module.exports=function(s,o){function t(s,o){var t=getClassName(o[1]),e=o[3],i=o[4],n=o.index+o[1].length+o[2].length,r=e.length+i.length;s.css=s.css.slice(0,n)+s.css.slice(n+r);var c=splitter(i);return c.forEach(function(o){s.compositions[t]||(s.compositions[t]={}),s.compositions[o]||(s.compositions[o]={}),s.compositions[t][o]=s.compositions[o]}),s}for(var e,i=[];e=regex.exec(s);)i.unshift(e);return i.reduce(t,{css:s,compositions:{}})};


},{"./composition":26}],29:[function(require,module,exports){
"use strict";module.exports=" css ";


},{}],30:[function(require,module,exports){
"use strict";var cssKey=require("./css-key");module.exports=function(e){return e[cssKey]};
...
"use strict";function scopify(e,s){function r(e,r){function c(a,c,i){var o=s[i]?i:n(i);return e[r][o]=i,c+o}var i=a[r];return{css:e.css.replace(i,c),keyframes:e.keyframes,classes:e.classes}}var n=fileScoper(e),a={classes:classRegex,keyframes:keyframesRegex},c=Object.keys(a).reduce(r,{css:e,keyframes:{},classes:{}});return replaceAnimations(c)}function replaceAnimations(e){var s=Object.keys(e.keyframes).reduce(function(s,r){return s[e.keyframes[r]]=r,s},{}),r=Object.keys(s);if(r.length){var n="((?:animation|animation-name)\\s*:[^};]*)("+r.join("|")+")"+ignoreComments,a=new RegExp(n,"g"),c=e.css.replace(a,function(e,r,n){return r+s[n]});return{css:c,keyframes:e.keyframes,classes:e.classes}}return e}var fileScoper=require("./scoped-name"),findClasses=/(\.)(?!\d)([^\s\.,{\[>+~#:]*)(?![^{]*})/.source,findKeyframes=/(@\S*keyframes\s*)([^{\s]*)/.source,ignoreComments=/(?!(?:[^*\/]|\*[^\/]|\/[^*])*\*+\/)/.source,classRegex=new RegExp(findClasses+ignoreComments,"g"),keyframesRegex=new RegExp(findKeyframes+ignoreComments,"g");module.exports=scopify;
...
function quot(e){return e===ATTR_VALUE_SQ||e===ATTR_VALUE_DQ}function has(e,T){return hasOwn.call(e,T)}function selfClosing(e){return closeRE.test(e)}var VAR=0,TEXT=1,OPEN=2,CLOSE=3,ATTR=4,ATTR_KEY=5,ATTR_KEY_W=6,ATTR_VALUE_W=7,ATTR_VALUE=8,ATTR_VALUE_SQ=9,ATTR_VALUE_DQ=10;module.exports=function(e,T){function A(e){return"function"==typeof e?e:"string"==typeof e?e:e&&"object"==typeof e?e:t("",e)}T||(T={});var t=T.concat||function(e,T){return String(e)+String(T)};return function(T){function n(e){var T=[];r===ATTR_VALUE_W&&(r=ATTR);for(var A=0;A<e.length;A++){var t=e.charAt(A);r===TEXT&&"<"===t?(s.length&&T.push([TEXT,s]),s="",r=OPEN):">"!==t||quot(r)?r===TEXT?s+=t:r===OPEN&&/\s/.test(t)?(T.push([OPEN,s]),s="",r=ATTR):r===OPEN?s+=t:r===ATTR&&/[\w-]/.test(t)?(r=ATTR_KEY,s=t):r===ATTR_KEY&&/\s/.test(t)?(T.push([ATTR_KEY,s]),s="",r=ATTR_KEY_W):r===ATTR_KEY&&"="===t?(T.push([ATTR_KEY,s]),s="",r=ATTR_VALUE_W):r===ATTR_KEY?s+=t:r===ATTR_KEY_W&&"="===t?r=ATTR_VALUE_W:r!==ATTR_KEY_W||/\s/.test(t)?r===ATTR_VALUE_W&&'"'===t?r=ATTR_VALUE_DQ:r===ATTR_VALUE_W&&"'"===t?r=ATTR_VALUE_SQ:r===ATTR_VALUE_DQ&&'"'===t?(T.push([ATTR_VALUE,s]),s="",r=ATTR):r===ATTR_VALUE_SQ&&"'"===t?(T.push([ATTR_VALUE,s]),s="",r=ATTR):r!==ATTR_VALUE_W||/\s/.test(t)?r===ATTR_VALUE&&/\s/.test(t)?(T.push([ATTR_VALUE,s]),s="",r=ATTR):r!==ATTR_VALUE&&r!==ATTR_VALUE_SQ&&r!==ATTR_VALUE_DQ||(s+=t):(r=ATTR_VALUE,A--):(r=ATTR,A--):(r===OPEN?T.push([OPEN,s]):r===ATTR_KEY?T.push([ATTR_KEY,s]):r===ATTR_VALUE&&s.length&&T.push([ATTR_VALUE,s]),T.push([CLOSE]),s="",r=TEXT)}return r===TEXT&&s.length?(T.push([TEXT,s]),s=""):r===ATTR_VALUE&&s.length?(T.push([ATTR_VALUE,s]),s=""):r===ATTR_VALUE_DQ&&s.length?(T.push([ATTR_VALUE,s]),s=""):r===ATTR_VALUE_SQ&&s.length?(T.push([ATTR_VALUE,s]),s=""):r===ATTR_KEY&&(T.push([ATTR_KEY,s]),s=""),T}for(var r=TEXT,s="",E=arguments.length,_=[],R=0;R<T.length;R++)if(E-1>R){var f=arguments[R+1],l=n(T[R]),o=r;o===ATTR_VALUE_DQ&&(o=ATTR_VALUE),o===ATTR_VALUE_SQ&&(o=ATTR_VALUE),o===ATTR_VALUE_W&&(o=ATTR_VALUE),o===ATTR&&(o=ATTR_KEY),l.push([VAR,o,f]),_.push.apply(_,l)}else _.push.apply(_,n(T[R]));for(var h=[null,{},[]],i=[[h,-1]],R=0;R<_.length;R++){var a=i[i.length-1][0],l=_[R],p=l[0];if(p===OPEN&&/^\//.test(l[1])){var u=i[i.length-1][1];i.length>1&&(i.pop(),i[i.length-1][0][2][u]=e(a[0],a[1],a[2].length?a[2]:void 0))}else if(p===OPEN){var g=[l[1],{},[]];a[2].push(g),i.push([g,a[2].length-1])}else if(p===ATTR_KEY||p===VAR&&l[1]===ATTR_KEY){for(var L,V="";R<_.length;R++)if(_[R][0]===ATTR_KEY)V=t(V,_[R][1]);else{if(_[R][0]!==VAR||_[R][1]!==ATTR_KEY)break;if("object"!=typeof _[R][2]||V)V=t(V,_[R][2]);else for(L in _[R][2])_[R][2].hasOwnProperty(L)&&!a[1][L]&&(a[1][L]=_[R][2][L])}for(;R<_.length;R++)if(_[R][0]===ATTR_VALUE)a[1][V]?a[1][V]=t(a[1][V],_[R][1]):a[1][V]=A(_[R][1]);else{if(_[R][0]!==VAR||_[R][1]!==ATTR_VALUE){R--;break}a[1][V]?a[1][V]=t(a[1][V],_[R][2]):a[1][V]=A(_[R][2])}}else if(p===ATTR_KEY)a[1][l[1]]=!0;else if(p===VAR&&l[1]===ATTR_KEY)a[1][l[2]]=!0;else if(p===CLOSE){if(selfClosing(a[0])&&i.length){var u=i[i.length-1][1];i.pop(),i[i.length-1][0][2][u]=e(a[0],a[1],a[2].length?a[2]:void 0)}}else if(p===VAR&&l[1]===TEXT)void 0===l[2]||null===l[2]?l[2]="":l[2]||(l[2]=t("",l[2])),Array.isArray(l[2][0])?a[2].push.apply(a[2],l[2]):a[2].push(l[2]);else{if(p!==TEXT)throw new Error("unhandled: "+p);a[2].push(l[1])}}if(h[2].length>1&&/^\s*$/.test(h[2][0])&&h[2].shift(),h[2].length>2||2===h[2].length&&/\S/.test(h[2][1]))throw new Error("multiple root elements must be wrapped in an enclosing tag");return h[2][0]}};var hasOwn=Object.prototype.hasOwnProperty,closeRE=RegExp("^("+["area","base","basefont","bgsound","br","col","command","embed","frame","hr","img","input","isindex","keygen","link","meta","param","source","track","wbr","animate","animateTransform","circle","cursor","desc","ellipse","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence","font-face-format","font-face-name","font-face-uri","glyph","glyphRef","hkern","image","line","missing-glyph","mpath","path","polygon","polyline","rect","set","stop","tref","use","view","vkern"].join("|")+")(?:[.#][a-zA-Z0-9-￿_:-]+)*$");
...
},{"observ":46,"xtend":43}],43:[function(require,module,exports){
...
},{"observ":46,"xtend":45}],45:[function(require,module,exports){
function extend(){for(var r={},e=0;e<arguments.length;e++){var n=arguments[e];for(var t in n)n.hasOwnProperty(t)&&(r[t]=n[t])}return r}module.exports=extend;
...
},{"assert":13}],48:[function(require,module,exports){
...
},{"./isObject":52,"./isSoftSetHook":53}],49:[function(require,module,exports){
...
},{"./applyProperties":48,"./isVNode":54,"./isVText":55}],50:[function(require,module,exports){
...
},{"./patchRecursive":57}],52:[function(require,module,exports){
...
},{"./types":58}],55:[function(require,module,exports){
...
},{"../patchTypes":59,"./applyProperties":48,"./createElement":49}],57:[function(require,module,exports){
...
},{"./domIndex":50,"./patchOp":56}],58:[function(require,module,exports){
...
},{"../patchTypes":59,"vdom-as-json/toJson":63}],61:[function(require,module,exports){
...
},{"./types":62,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":85}],62:[function(require,module,exports){
module.exports={VirtualTree:1,VirtualPatch:2,VirtualNode:3,SoftSetHook:4};
...
},{"./lib/toJson":61}],64:[function(require,module,exports){
module.exports=require("./lib/patch");


},{"./lib/patch":51}],65:[function(require,module,exports){
module.exports=require("./lib/serialize");


},{"./lib/serialize":60}],66:[function(require,module,exports){
var createElement=require("./vdom/create-element.js");module.exports=createElement;


},{"./vdom/create-element.js":79}],67:[function(require,module,exports){
var diff=require("./vtree/diff.js");module.exports=diff;


},{"./vtree/diff.js":99}],68:[function(require,module,exports){
var h=require("./virtual-hyperscript/index.js");module.exports=h;


},{"./virtual-hyperscript/index.js":86}],69:[function(require,module,exports){
...
},{"./create-element.js":66,"./diff.js":67,"./h.js":68,"./patch.js":77,"./vnode/vnode.js":95,"./vnode/vtext.js":97}],70:[function(require,module,exports){
...
},{"min-document":14}],75:[function(require,module,exports){
"use strict";module.exports=function(t){return"object"==typeof t&&null!==t};
...
},{"./create-element":79,"./dom-index":80,"./patch-op":81,"global/document":74,"x-is-array":76}],83:[function(require,module,exports){
...
},{"./trie":102,"assert":13,"sliced":101}],101:[function(require,module,exports){
...
},{"./model":110,"./router":111,"./utils":112,"./view":113}],109:[function(require,module,exports){
"use strict";var duet=require("duet"),app=require("./app");duet(app,".todoapp",{isDebug:!0,isHashRouter:!0});


},{"./app":108,"duet":7}],110:[function(require,module,exports){
...
},{"./utils":112,"duet":7}],111:[function(require,module,exports){
...
},{"./Footer":105,"./Header":106,"./Main":107,"duet":7}]},{},[109]);
