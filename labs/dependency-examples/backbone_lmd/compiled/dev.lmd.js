...
"Workspace": (function (require, exports, module) { /* wrapped by builder */
var $ = require('$'),
    Backbone = require('Backbone'),
    Todos = require('Todos'),
...
"Todo": (function (require, exports, module) { /* wrapped by builder */
var _ = require('_'),
    Backbone = require('Backbone');
...
"Todos": (function (require, exports, module) { /* wrapped by builder */
var _ = require('_'),
    Backbone = require('Backbone'),
    Store = require('Store'),
    Todo = require('Todo');
...
"TodoView": (function (require, exports, module) { /* wrapped by builder */
var $ = require('$'),
    _ = require('_'),
    Backbone = require('Backbone'),
...
"statsTemplate": "<span id=\"todo-count\"><strong><%= remaining %></strong> <%= remaining == 1 ? 'item' : 'items' %> left</span>\n<ul id=\"filters\">\n\t<li>\n\t\t<a class=\"selected\" href=\"#/\">All</a>\n\t</li>\n\t<li>\n\t\t<a href=\"#/active\">Active</a>\n\t</li>\n\t<li>\n\t\t<a href=\"#/completed\">Completed</a>\n\t</li>\n</ul>\n<% if ( completed ) { %>\n<button id=\"clear-completed\">Clear completed (<%= completed %>)</button>\n<% } %>\n",
"todosTemplate": "<div class=\"view\">\n\t<input class=\"toggle\" type=\"checkbox\" <%= completed ? 'checked' : '' %>>\n\t<label><%- title %></label>\n\t<button class=\"destroy\"></button>\n</div>\n<input class=\"edit\" value=\"<%- title %>\">\n"
},{})